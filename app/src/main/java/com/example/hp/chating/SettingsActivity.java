...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChangeImage = (Button) findViewById(R.id.settings_image_btn);
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default"))
                {
                    Picasso.with(SettingsActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                            .placeholder(R.drawable.contact).into(mDisplayImage, new Callback() {
                        @Override
                        ...
                        public void onError() {
                            ...
                            Picasso.with(SettingsActivity.this).load(image).placeholder(R.drawable.contact).into(mDisplayImage);
